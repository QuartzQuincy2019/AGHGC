...
var NORMAL_VERSIONS = {
    // "4.2@2": new Version("4.2", 2, "2026-06-03", 21, false),
    // "4.2@1": new Version("4.2", 1, "2026-05-13", 21, false),
    // "4.1@2": new Version("4.1", 2, "2026-04-22", 21, false),
    "4.1@1": new Version("4.1", 1, "2026-03-25", 21, false),
    "4.0@2": new Version("4.0", 2, "2026-03-03", 22, false, { "zh-CN": "满月是神不在的时间", "en": "No Aha At Full Moon", "jp": "月満ちる時に神はなし" }),
    "4.0@1": new Version("4.0", 1, "2026-02-13", 18, false, { "zh-CN": "满月是神不在的时间", "en": "No Aha At Full Moon", "jp": "月満ちる時に神はなし" }),
    "3.8@3": new Version("3.8", 3, "2026-01-28", 16, false, { "zh-CN": "记忆是梦的开场白", "en": "Memories are the Prelude to Dreams", "jp": "記憶は夢のプロローグ" }),
