...
var CHARACTER_LIST = [
    new Character("c000", 4, CombatType.physical, Path.destruction, { "zh-CN": "四星陪跑", "en": "4*Up", "jp": "4*Up" }),
    //1.0
    ...
    new Character("bron", 5, CombatType.wind, Path.harmony, { "zh-CN": "布洛妮娅", "en": "Bronya", "jp": "ブローニャ" }, { "exclusiveLc": "butthe5", "alias": ["鸭", "大鸭鸭"] }),
    ...
    //1.2
    new Character("blad", 5, CombatType.wind, Path.destruction, { "zh-CN": "刃", "en": "Blade", "jp": "刃" }, { "alias": ["牢刃", "应星"] }),
    new Character("kafk", 5, CombatType.lightning, Path.nihility, { "zh-CN": "卡芙卡", "en": "Kafka", "jp": "カフカ" }, { "alias": ["卡妈"], "exclusiveLc": "patien5" }),
    new Character("luka", 4, CombatType.physical, Path.nihility, { "zh-CN": "卢卡", "en": "Luka", "jp": "ルカ" }),
    //1.3
    new Character("dhil", 5, CombatType.imaginary, Path.destruction, { "zh-CN": "丹恒·饮月", "en": "Dan Heng • Imbibitor Lunae", "jp": "丹恒・飲月" }, { "alias": ["饮月君", "丹恒饮月", "sp丹恒", "SP丹恒", "饮月"] }),
    ...
    //1.5
    new Character("arge", 5, CombatType.physical, Path.erudition, { "zh-CN": "银枝", "en": "Argenti", "jp": "アルジェンティ" }, { "exclusiveLc": "aninst5" }),
    ...
    new Character("rmei", 5, CombatType.ice, Path.harmony, { "zh-CN": "阮·梅", "en": "Ruan Mei", "jp": "ルアン・メェイ" }, { "alias": ["阮梅"], "exclusiveLc": "pastse4" }),
    new Character("xuey", 4, CombatType.quantum, Path.destruction, { "zh-CN": "雪衣", "en": "Xueyi", "jp": "雪衣" }),
    //2.0
    new Character("blsw", 5, CombatType.wind, Path.nihility, { "zh-CN": "黑天鹅", "en": "Black Swan", "jp": "ブラックスワン" }, { "exclusiveLc": "reforg2" }),
    ...
    //2.7
    new Character("fugu", 5, CombatType.fire, Path.nihility, { "zh-CN": "忘归人", "en": "Fugue", "jp": "帰忘の流離人" }, { "exclusiveLc": "longro4", "alias": ["大停云", "sp停云", "SP停云"] }),
    ...
    //3.5
    new Character("hysi", 5, CombatType.physical, Path.nihility, { "zh-CN": "海瑟音", "en": "Hysilens", "jp": "セイレンス" }, { "exclusiveLc": "whydoe5" }),
    new Character("cery", 5, CombatType.wind, Path.harmony, { "zh-CN": "刻律德菈", "en": "Cerydra", "jp": "ケリュドラ" }, { "exclusiveLc": "epoche5" }),
    //3.6
    new Character("ever", 5, CombatType.ice, Path.remembrance, { "zh-CN": "长夜月", "en": "Evernight", "jp": "長夜月" }, { "alias": ["sp三月七", "SP三月七", "伞月七", "黑三月七", "Darch"] }),
    new Character("dhpt", 5, CombatType.physical, Path.preservation, { "zh-CN": "丹恒·腾荒", "en": "Dan Heng • Permansor Terrae", "jp": "丹恒・騰荒" }, { "alias": ["sp丹恒", "SP丹恒", "丹恒腾荒", "腾荒"] }),
    //3.7
    // new Character("cyre", 5, CombatType.ice, Path.remembrance, { "zh-CN": "昔涟", "en": "Cyrene", "jp": "キュレネ" }),
    //3.8
    // new Character("", 5, CombatType., Path., { "zh-CN": "", "en": "", "jp": "" }),
];

var LIGHTCONE_LIST = [
    new Lightcone("l000000", 4, Path.destruction, { "zh-CN": "四星陪跑", "en": "4*Up", "jp": "4*Up" }),
    // 
    ...
    new Lightcone("aninst5", 5, Path.erudition, { "zh-CN": "片刻，留在眼底", "en": "An Instant Before A Gaze", "jp": "その一刻、目に焼き付けて" }),
    ...
    new Lightcone("epoche5", 5, Path.harmony, { "zh-CN": "金血铭刻的时代", "en": "Epoch Etched in Golden Blood", "jp": "黄金の血で刻む時代" }),
    ...
    new Lightcone("ishall6", 5, Path.destruction, { "zh-CN": "此身为剑", "en": "I Shall Be My Own Sword", "jp": "この身は剣なり" }),
    ...
    new Lightcone("pastse4", 5, Path.harmony, { "zh-CN": "镜中故我", "en": "Past Self in Mirror", "jp": "鏡の中の私" }),
    new Lightcone("patien5", 5, Path.nihility, { "zh-CN": "只需等待", "en": "Patience Is All You Need", "jp": "待つのみ" }),
    new Lightcone("reforg2", 5, Path.nihility, { "zh-CN": "重塑时光之忆", "en": "Reforged Remembrance", "jp": "時間の記憶を再構築して" }),
...
function refreshAllPoolSupCode() {
    ALL_WARP_POOLS = rearrangeAllWarpPools(TOTAL_EVENT_WARPS, OFFICIAL_VERSIONS_KEYS);
    // console.log("refreshAllPoolSupCode:" + ALL_WARP_POOLS.length);
